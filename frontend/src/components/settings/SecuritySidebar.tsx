...
import { ChevronRight, History, ShieldCheck, Users } from 'lucide-react';
...
const ITEMS: NavItem[] = [
  ...
  },
  {
    id: 'login-history',
    label: 'Login history',
    description: 'Review recent access',
    icon: History,
  },
  {
    id: 'role-access',
...
export function SecuritySidebar({
  ...
  return (
    <nav aria-label="Security sections" className="flex w-full flex-col gap-4 lg:w-80">
